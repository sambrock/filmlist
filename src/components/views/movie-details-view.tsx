...
export const MovieDetailsView = async ({ movieId }: Props) => {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 flex h-screen w-screen items-start justify-center overflow-y-auto bg-black/50">
      <div className="bg-background-1 my-12 w-6xl overflow-clip rounded-lg shadow shadow-black/30">
        <div className="relative flex h-[560px] items-center overflow-clip">
          ...
          <div className="absolute bottom-0 grid w-full grid-cols-[200px_1fr] gap-6 p-8 px-6">
            <img
              className="rounded-md shadow-lg shadow-black/40"
              src={posterSrc(movie.poster_path!, 'w500')}
            />
            <div className="mb-2 flex flex-col justify-end">
              <div className="mb-2 flex items-end text-5xl font-black">
                {movie.title}{' '}
                <span className="text-foreground-1 ml-3 flex gap-1 text-sm font-medium mb-0.5">
              ...
              <div className="text-foreground-1 flex gap-1 text-sm font-medium">
                ...
                <span>
                  Directed by{' '}
                  <span className="text-foreground-0/70">
