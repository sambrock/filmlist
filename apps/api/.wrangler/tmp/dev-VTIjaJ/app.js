...
// .wrangler/tmp/bundle-78W0YM/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-78W0YM/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
function getErrorShape(opts) {
  const { path, error: error3, config: config3 } = opts;
...
function isAbortError(error3) {
  return isObject(error3) && error3["name"] === "AbortError";
}
...
// ../../node_modules/@trpc/server/dist/unstable-core-do-not-import/stream/utils/asyncIterable.mjs
function _ts_add_disposable_resource(env2, value, async) {
...
function _ts_dispose_resources(env2) {
  ...
  return (_ts_dispose_resources = /* @__PURE__ */ __name(function _ts_dispose_resources5(env3) {
    function fail(e) {
...
async function* withMaxDuration(iterable, opts) {
  ...
  try {
    const iterator = _ts_add_disposable_resource(env2, iteratorResource(iterable), true);
    ;
    const timer = _ts_add_disposable_resource(env2, timerResource(opts.maxDurationMs), false);
    ;
...
async function* takeWithGrace(iterable, opts) {
  ...
  try {
    ...
    ;
    let result;
    const timer = _ts_add_disposable_resource(env2, timerResource(opts.gracePeriodMs), false);
    ;
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
function _ts_add_disposable_resource2(env2, value, async) {
  if (value !== null && value !== void 0) {
    if (typeof value !== "object" && typeof value !== "function") throw new TypeError("Object expected.");
    var dispose, inner;
    {
...
function _ts_dispose_resources2(env2) {
  var _SuppressedError = typeof SuppressedError === "function" ? SuppressedError : function(error3, suppressed, message) {
    var e = new Error(message);
    return e.name = "SuppressedError", e.error = error3, e.suppressed = suppressed, e;
  };
  return (_ts_dispose_resources2 = /* @__PURE__ */ __name(function _ts_dispose_resources5(env3) {
    function fail(e) {
      env3.error = env3.hasError ? new _SuppressedError(e, env3.error, "An error was suppressed during disposal.") : e;
      env3.hasError = true;
    }
  ...
  return {
    ...
    async *[Symbol.asyncIterator]() {
      ...
      try {
        ...
        state = "pending";
        const _finally = _ts_add_disposable_resource2(env2, makeAsyncResource({}, async () => {
          state = "done";
          const errors = [];
        ...
        const result = _ts_dispose_resources2(env2);
        if (result) await result;
      }
    }
  };
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
function _ts_add_disposable_resource3(env2, value, async) {
  if (value !== null && value !== void 0) {
    if (typeof value !== "object" && typeof value !== "function") throw new TypeError("Object expected.");
    var dispose, inner;
    if (async) {
...
__name(_ts_add_disposable_resource3, "_ts_add_disposable_resource");
function _ts_dispose_resources3(env2) {
  var _SuppressedError = typeof SuppressedError === "function" ? SuppressedError : function(error3, suppressed, message) {
    var e = new Error(message);
    return e.name = "SuppressedError", e.error = error3, e.suppressed = suppressed, e;
  };
  return (_ts_dispose_resources3 = /* @__PURE__ */ __name(function _ts_dispose_resources5(env3) {
    function fail(e) {
      env3.error = env3.hasError ? new _SuppressedError(e, env3.error, "An error was suppressed during disposal.") : e;
      env3.hasError = true;
    }
...
__name(_ts_dispose_resources3, "_ts_dispose_resources");
...
async function* withPing(iterable, pingIntervalMs) {
  ...
  try {
    const iterator = _ts_add_disposable_resource3(env2, iteratorResource(iterable), true);
    ;
    let result;
    ...
    while (true) {
      ...
      try {
        const pingPromise = _ts_add_disposable_resource3(env3, timerResource(pingIntervalMs), false);
        ;
        result = await Unpromise.race([
          nextPromise,
          pingPromise.start()
    ...
    const result = _ts_dispose_resources3(env2);
    if (result) await result;
  }
}
...
function _ts_add_disposable_resource4(env2, value, async) {
  if (value !== null && value !== void 0) {
    if (typeof value !== "object" && typeof value !== "function") throw new TypeError("Object expected.");
    var dispose, inner;
    if (async) {
...
__name(_ts_add_disposable_resource4, "_ts_add_disposable_resource");
function _ts_dispose_resources4(env2) {
  var _SuppressedError = typeof SuppressedError === "function" ? SuppressedError : function(error3, suppressed, message) {
    var e = new Error(message);
    return e.name = "SuppressedError", e.error = error3, e.suppressed = suppressed, e;
  };
  return (_ts_dispose_resources4 = /* @__PURE__ */ __name(function _ts_dispose_resources5(env3) {
    function fail(e) {
      env3.error = env3.hasError ? new _SuppressedError(e, env3.error, "An error was suppressed during disposal.") : e;
      env3.hasError = true;
    }
...
__name(_ts_dispose_resources4, "_ts_dispose_resources");
...
var MaxDepthError = class extends Error {
  ...
  constructor(path) {
    super("Max depth reached at path: " + path.join(".")), _define_property3(this, "path", void 0), this.path = path;
  }
};
async function* createBatchStreamProducer(opts) {
  ...
  function encodePromise(promise, path) {
    return registerAsync(async function* (idx) {
      const error3 = checkMaxDepth(path);
      if (error3) {
        promise.catch((cause) => {
          opts.onError?.({
            error: cause,
  ...
  function encodeAsyncIterable(iterable2, path) {
    return registerAsync(async function* (idx) {
      ...
      try {
        ...
        const iterator = _ts_add_disposable_resource4(env2, iteratorResource(iterable2), true);
        ;
        try {
          while (true) {
        ...
        const result = _ts_dispose_resources4(env2);
        if (result) await result;
      }
    });
  }
...
var jsonContentTypeHandler = {
  ...
  async parse(opts) {
    ...
    const calls = await Promise.all(paths.map(async (path, index) => {
      const procedure2 = await getProcedureAtPath(opts.router, path);
      return {
        path,
        ...
        getRawInput: /* @__PURE__ */ __name(async () => {
          ...
          if (procedure2?._def.type === "subscription") {
    ...
    const type2 = types.values().next().value ?? "unknown";
...
var formDataContentTypeHandler = {
  ...
  async parse(opts) {
    ...
    const procedure2 = await getProcedureAtPath(opts.router, opts.path);
    return {
      accept: null,
      calls: [
        {
...
function initResponse(initOpts) {
  ...
  const meta = responseMeta?.({
    ctx,
    info: info3,
    paths: info3?.calls.map((call) => call.path),
    data,
    errors,
    eagerGeneration,
    type: info3?.calls.find((call) => call.procedure?._def.type)?.procedure?._def.type ?? "unknown"
  }) ?? {};
  if (meta.headers) {
...
async function resolveResponse(opts) {
  ...
  const experimentalSSE = config3.sse?.enabled ?? true;
  try {
    const [infoError, info3] = infoTuple;
    if (infoError) {
      throw infoError;
    }
    if (info3.isBatchCall && !allowBatching) {
      throw new TRPCError({
        code: "BAD_REQUEST",
        message: `Batching is not enabled on the server`
      });
    }
    if (isStreamCall && !info3.isBatchCall) {
      throw new TRPCError({
    ...
    if (!info3.isBatchCall) {
      ...
      const [error3, result] = await rpcCalls[0];
      switch (info3.type) {
        case "unknown":
        case "mutation":
        case "query": {
        ...
        case "subscription": {
          const iterable = run(() => {
            if (error3) {
              return errorToAsyncIterable(error3);
            }
            if (!experimentalSSE) {
          ...
          const stream = sseStreamProducer({
            ...
            formatError(errorOpts) {
              const error4 = getTRPCErrorFromUnknown(errorOpts.error);
              const input = call?.result();
              const path = call?.path;
              const type2 = call?.procedure?._def.type ?? "unknown";
              opts.onError?.({
                error: error4,
                path,
                input,
      ...
      const stream = jsonlStreamProducer({
        ...
        */
        ...
        data: rpcCalls.map(async (res) => {
          const [error3, result] = await res;
          const call = info3.calls[0];
          if (error3) {
            return {
              error: getErrorShape({
                config: config3,
        ...
        serialize: config3.transformer.output.serialize,
        onError: /* @__PURE__ */ __name((cause) => {
          opts.onError?.({
            ...
            ctx: ctxManager.valueOrUndefined(),
            req: opts.req,
            type: info3?.type ?? "unknown"
          });
        }, "onError"),
        formatError(errorOpts) {
          const call = info3?.calls[errorOpts.path[0]];
          const error3 = getTRPCErrorFromUnknown(errorOpts.error);
          const input = call?.result();
          const path = call?.path;
          const type2 = call?.procedure?._def.type ?? "unknown";
          const shape = getErrorShape({
    ...
    const resultAsRPCResponse = results.map(([error3, result], index) => {
      const call = info3.calls[index];
      if (error3) {
        return {
          error: getErrorShape({
            config: config3,
    ...
    const errors = results.map(([error3]) => error3).filter(Boolean);
    ...
    const { error: error3, untransformedJSON, body } = caughtErrorToData(cause, {
      opts,
      ctx: ctxManager.valueOrUndefined(),
      type: info3?.type ?? "unknown"
    });
...
function drizzle(client2, config3 = {}) {
  ...
  const session = new SQLiteD1Session(client2, dialect, schema, { logger });
...
// ../../packages/drizzle/src/schema/list-movies.schema.ts
var listMovies = sqliteTable("list-movies", {
...
var databaseMiddleware = t.middleware(({ ctx, next }) => {
  let db = ctx.db;
...
var authMiddleware = t.middleware(({ ctx, next }) => {
  const user = { id: 1, username: "username" };
  return next({
    ctx: { ...ctx, user }
  });
});
var authedProcedure = procedure.use(authMiddleware).use(databaseMiddleware);

// src/lists/lists.router.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/lists/mutation-add-movie.handler.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/lists/mutation-add-movie.handler.ts
var addMovieToListInputSchema = z.object({
  listId: z.number(),
  movieId: z.number()
});
var addMovieToListHandler = /* @__PURE__ */ __name(async (input, ctx) => {
...
// src/movies/movies.router.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/movies/query-search-movies.handler.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/movies/query-search-movies.handler.ts
var searchMoviesInputSchema = z.object({
  query: z.string(),
  year: z.string().length(4).regex(/^\d{4}$/).optional()
});
var searchMoviesHandler = /* @__PURE__ */ __name(async ({ query, year }) => {
  const { data } = await client_exports.client.GET("/3/search/movie", {
    params: {
      query: {
        query,
        year,
  ...
  const withDirectors = await Promise.all(
    results.map(async (m) => {
      const { data: data2 } = await client_exports.client.GET("/3/movie/{movie_id}/credits", {
        params: {
          path: { movie_id: m.id }
        }
      });
      return {
        ...m,
        directors: data2?.crew?.filter((person) => person.job === "Director").map((person) => person.name) || []
      };
    })
  );
...
// src/app.router.ts
var appRouter = mergeRouters2(listRouter, movieRouter);
