...
// .wrangler/tmp/bundle-xlaxR2/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-xlaxR2/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// ../../packages/drizzle/src/index.ts
var initDatabase = /* @__PURE__ */ __name((binding2) => {
...
var procedureWithDatabase = procedure.use(({ ctx, next }) => {
  let db = ctx.db;
...
var authedProcedure = procedureWithDatabase.use(({ ctx, next }) => {
