...
// .wrangler/tmp/bundle-Aitp3E/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-Aitp3E/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
async function fetchRequestHandler(opts) {
  ...
  const createContext = /* @__PURE__ */ __name(async () => {
  ...
  const unstable_onChunk = /* @__PURE__ */ __name(([index, string]) => {
    if (index === -1) {
...
function createProcedureCaller(_def) {
  const procedure2 = /* @__PURE__ */ __name(async function resolve(opts) {
...
// ../../packages/drizzle/src/schema/likes.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// ../../packages/drizzle/src/schema/ratings.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../../packages/drizzle/src/schema/users.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../../packages/drizzle/src/schema/watched.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var watched = sqliteTable("watched", {
  id: integer().primaryKey(),
  userId: integer().notNull(),
  movieId: integer().notNull(),
  createdAt: text().notNull().default(sql`(CURRENT_TIMESTAMP)`)
});
var watchedRelations = relations(watched, ({ one }) => ({
...
var ratings = sqliteTable(
  ...
  (t2) => [unique().on(t2.userId, t2.movieId)]
);
...
// ../../packages/drizzle/src/schema/watchlist.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/routers/activity/activity.router.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/routers/activity/activity.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/routers/activity/activity.schema.ts
var getUserMovieActivityInput = z.object({
  movieId: z.number()
});
var getUserMovieActivityOutput = z.object({
  watched: z.boolean(),
  liked: z.boolean(),
  rating: z.number()
  // watchlist
});
var watchMovieInput = z.object({
  movieId: z.number(),
  watched: z.boolean()
});
var likeMovieInput = z.object({
  movieId: z.number(),
  liked: z.boolean()
});
var rateMovieInput = z.object({
  movieId: z.number(),
  rating: z.number().max(10)
});

// src/routers/activity/activity.service.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var getUserMovieActivity = /* @__PURE__ */ __name(async (input, ctx) => {
  const { movieId } = input;
  const { db, user } = ctx;
  const [watched2, liked, rating] = await Promise.all([
    db.query.watched.findFirst({
      where: /* @__PURE__ */ __name((watched3) => and(eq(watched3.userId, user.id), eq(watched3.movieId, movieId)), "where")
    }),
    db.query.likes.findFirst({
      where: /* @__PURE__ */ __name((likes2) => and(eq(likes2.userId, user.id), eq(likes2.movieId, movieId)), "where")
    }),
    db.query.ratings.findFirst({
      where: /* @__PURE__ */ __name((ratings2) => and(eq(ratings2.userId, user.id), eq(ratings2.movieId, movieId)), "where")
    })
  ]);
  return {
    watched: !!watched2,
...
var watchMovie = /* @__PURE__ */ __name((input, ctx) => {
  const { movieId } = input;
  const { db, user } = ctx;
  if (input.watched) {
...
var likeMovie = /* @__PURE__ */ __name((input, ctx) => {
...
var rateMovie = /* @__PURE__ */ __name((input, ctx) => {
  const { movieId, rating } = input;
  const { db, user } = ctx;
  return db.insert(ratings).values({ movieId, userId: user.id, rating }).onConflictDoUpdate({
...
// src/routers/movies/movies.router.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// src/routers/movies/movies.schema.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var getMovieInput = z.object({
  movieId: z.number()
});
var getMovieOutput = z.object({
  movieId: z.number(),
  title: z.string(),
...
var getMovieCastInput = z.object({
  movieId: z.number()
});
var getMovieWatchProvidersInput = z.object({
  movieId: z.number()
});
var getMovieWatchProvidersOutput = z.object({
  providerId: z.number(),
  providerName: z.string(),
  logoPath: z.string(),
  options: z.enum(["buy", "rent", "stream"]).array()
});
var searchMoviesInput = z.object({
  query: z.string(),
  year: z.string().length(4).regex(/^\d{4}$/).optional()
});
var searchMoviesOutput = z.object({
  movieId: z.number(),
  title: z.string(),
  releaseDate: z.string(),
  posterPath: z.string(),
...
var getPopularMoviesOutput = z.object({
  movieId: z.number(),
  title: z.string(),
  releaseDate: z.string(),
  posterPath: z.string()
...
// src/routers/movies/movies.service.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
// src/routers/movies/movies.service.ts
var getMovie = /* @__PURE__ */ __name(async ({ movieId }, ctx) => {
  const { data } = await client_exports.client.GET("/3/movie/{movie_id}", {
    params: {
...
var getMovieCast = /* @__PURE__ */ __name(async ({ movieId }, ctx) => {
  const { data } = await client_exports.client.GET("/3/movie/{movie_id}/credits", {
    params: {
      path: { movie_id: movieId }
    }
  });
...
var getMovieWatchProviders = /* @__PURE__ */ __name(async ({ movieId }, ctx) => {
  const { data } = await client_exports.client.GET("/3/movie/{movie_id}/watch/providers", {
    params: {
      path: { movie_id: movieId }
    }
  });
  ...
  return uniqueProviderIds.map((providerId) => ({
    providerId,
    providerName: providers.find((provider) => provider.provider_id === providerId)?.provider_name,
    logoPath: providers.find((provider) => provider.provider_id === providerId)?.logo_path,
    options: providers.filter((provider) => provider.provider_id === providerId).map((provider) => provider.type)
  }));
}, "getMovieWatchProviders");
var searchMovies = /* @__PURE__ */ __name(async ({ query, year }, ctx) => {
...
var getPopularMovies = /* @__PURE__ */ __name(async () => {
  const { data } = await client_exports.client.GET("/3/movie/popular");
...
// src/app.router.ts
var appRouter = mergeRouters2(activityRouter, movieRouter);
